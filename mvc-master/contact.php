                        ...
                        <form method="POST"  id="bt" >
                            ...
                            <div class="control-group">
                                <input type="email" name="email" class="form-control border-0 p-4" id="email" placeholder="Your Email"
                                    r data-bvalidator="required"/>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" name="subject" class="form-control border-0 p-4" id="subject" placeholder="Subject"
                                data-bvalidator="required" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <textarea name="message" class="form-control border-0 py-3 px-4" rows="3" id="message" placeholder="Message"
                                data-bvalidator="required"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div>
                                <button name="send" class="btn btn-primary py-3 px-4" type="submit" id="sendMessageButton">Send
                                    Message</button>
                            </div>
                        </form>
